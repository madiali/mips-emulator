public class Registers {
    ...
    /*
     * Note from Jesse: I removed the braces to make it look nicer.
     * Doesn't modify behavior, of course.
     */
    public static String registerToName(int regNumber) {
        if (regNumber == 0)
            ...
            return "$v" + (regNumber - 2);          // This automatically converts the int to a String in C# and Java, so it's fine
        else if (regNumber <= 7)
