...
import MIPS_Emulator.Instructions.IType.*;
import MIPS_Emulator.Instructions.Instruction;
import MIPS_Emulator.Instructions.JType.*;
import MIPS_Emulator.Instructions.RType.*;
...
public class InstructionFactory {
    ...
    /**
     * The original code assigns numeric values to enum elements, which isn't directly possible using = in Java
     * I could not get enums to work, so I'm just hardcoding it
     * Also, 0b100011 is recognized as positive 35, not a negative number. Yay!
     * - Jesse
     */
    ...
    public Instruction createInstruction(int instruction) {
        ...
        // But if we throw a UnknownInstructionException here, then this return statement may be unreachable, and that causes a compiler error
        // We also can't modify the switch statements with default: throw new UnknownInstructionException for the same reason
        return null;
    }
