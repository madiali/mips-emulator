...
public class ExecuteAll implements Runnable {
    ...
    public void run() {
        ...
        for (; MainController.getIsExecuting(); instructionsExecuted++) {
            ...
            else if (!(nextInstruction instanceof BeqInstruction) && !(nextInstruction instanceof BneInstruction) && !(nextInstruction instanceof JInstruction) && !(nextInstruction instanceof JrInstruction)) {
