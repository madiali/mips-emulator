...
public class ExecuteAllThrottled implements Runnable {
    private final static double TARGET_CONSTANT = 1.4;
    ...
    public void run() {
        ...
        while (MainController.getIsExecuting()) {
            ...
            if ((throttleStopwatch.getTimeElapsed() != 0) && (instructionsExecuted <= targetInstrPerMillisec * timeElapsed)) {
        ...
        System.out.println("Clock speed (avg): " + totalInstructionsExecuted / 1000000.0 / delta + " MHz");
    }
