 ...
 * TODO: parameterize (pixelSize), fix color. No need to scale images. If reformatting this file,
 * consider pasting in byte[] BMP_HEADER from a previous commit. The spacing and newlines are
 * relevant.
 *
 * For larger sprites, generateBMP() and bigEndianToLittleEndian would need to change, along with a bunch of
 * other stuff.
 *
...
public class VgaDisplayBMPController {
  ...
  // If this file is reformatted, please paste this array from a previous commit since its spacing and newlines are relevant
